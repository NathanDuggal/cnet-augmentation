...
for folder in os.listdir(path):
    for file in os.listdir(path + '/' + folder):
        ...
        print(image)
        new_image = image[:-4] + "-aug.jpg"

        if os.path.exists(new_image) or "aug" in file:
            print("skipping...")
            continue
        ...
        # color_seg = cv2.resize(color_seg, (512, 512))
        image = Image.fromarray(color_seg)

        # image.save('./images/building_seg.png')
        ...
        image = pipe(folder, image, num_inference_steps=20).images[0]
        # image.save('./images/building_seg_out_full.png')
        print("debug5")
